{
	...
	[
		...
		{
			"file": "test/fixtures/water-huge.json",
			"settings":
			{
				"buffer_size": 67253,
				"line_ending": "Unix"
		...
		{
			"file": "test/fixtures/hole-touching-outer.json",
			"settings":
			{
				"buffer_size": 937,
				"line_ending": "Unix"
		...
		{
			"file": "test/fixtures/touching-holes.json",
			"settings":
			{
				"buffer_size": 702,
				"line_ending": "Unix"
		...
		{
			"contents": "var poly = [];\ndo {\n    poly.push([data[ear.i], data[ear.i + 1], ear.i]);\n    ear = ear.next;\n} while (ear !== stop);\nconsole.log(JSON.stringify([poly]));",
			"settings":
			{
				"buffer_size": 154,
				"line_ending": "Unix"
	...
	[
		...
		"/Users/mourner/projects/earcut/test",
		"/Users/mourner/projects/earcut/test/fixtures",
	...
	"find_state":
	{
		...
		[
			"filterPoints",
			" || intersects(a, c, p, p.prev) || intersects(a, c, p, p.next)",
			" && !equals(p, ear)",
			"splitEarcut",
			" && !equals(p, ear)",
			"findholebridge",
